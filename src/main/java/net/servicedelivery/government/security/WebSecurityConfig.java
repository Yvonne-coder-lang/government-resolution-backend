package net.servicedelivery.government.security;

import net.servicedelivery.government.security.jwt.AuthTokenFilter;
import net.servicedelivery.government.security.jwt.JwtAuthEntryPoint;
...
public class WebSecurityConfig {
    ...
    private final Servicedelivery userDetailsService;
